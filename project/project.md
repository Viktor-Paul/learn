...
解压文件 tar -zxvf django-cors-headers-3.0.2.tar.gz
...
```python
		...
		7, CORS_PREFLIGHT_MAX_AGE  默认 86400s 1天
...
​		**网络上的一个实体，或者说是网络上的一个具体信息**，并且每个资源都有一个独一无二得URI与之对应；获取资源-直接访问URI （Uniform Resources Identifier 统一资源标识符）即可
