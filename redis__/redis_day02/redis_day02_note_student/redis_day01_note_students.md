...
```python
1、最新版本：5.0
2、常用版本：2.4、2.6、2.8、3.0（融入了集群，里程碑比如命令的优化）、3.2、3.4、4.0（教学环境版本）、5.0
3、图形界面管理工具(写的一般)
	RedisDesktopManager
```
...
# 客户端连接
redis-cli -h ip地址 -p (port) 6379 -a密码
ping 回应 pong
```
...
tarena@tarena:~$ nslookup www.baidu.com
Server:		127.0.0.53
